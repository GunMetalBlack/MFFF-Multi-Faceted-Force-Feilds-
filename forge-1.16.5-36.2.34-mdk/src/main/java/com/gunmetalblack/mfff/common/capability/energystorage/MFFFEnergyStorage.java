package com.gunmetalblack.mfff.common.capability.energystorage;
...
public class MFFFEnergyStorage extends EnergyStorage implements INBTSerializable<CompoundNBT> {

    public MFFFEnergyStorage() {
        super(0);
    }

    private Runnable callbackOnChanged = () -> {};

    public MFFFEnergyStorage setCallbackOnChanged(Runnable callbackOnChanged) {
        this.callbackOnChanged = callbackOnChanged;
        return this;
    }

    public MFFFEnergyStorage setCapacity(int capacity, boolean updateMaxThroughput) {
    ...
    public MFFFEnergyStorage setMaxReceive(int maxReceive) {
        this.maxReceive = maxReceive;
        callbackOnChanged.run();
        return this;
    }

    public MFFFEnergyStorage setMaxExtract(int maxExtract) {
    ...
    public MFFFEnergyStorage setEnergy(int energy) {
    ...
    public static enum EnergyMeasurementUnit {
        ...
        public static ITextComponent formatEnergyValue(long value, int decimalPlaces, boolean useShortName) {
            ...
            return new StringTextComponent(unitToUse.energyValueToString(value, decimalPlaces, useShortName)).append(new TranslationTextComponent("energy." + MFFF.MODID + ".forge" + (useShortName ? ".short" : "")));
        }
