...
public class ScreenMachine <T extends AbstractContainerMachine> extends ContainerScreen<T> implements IScreenMachine {
    ...
    public static final ResourceLocation DEFAULT_COMPONENTS_TEXTURE = new ResourceLocation(MFFF.MODID, "textures/gui/gui_components.png");
    public static final ResourceLocation DEFAULT_CONTAINER_BACKGROUND_TEXTURE = new ResourceLocation(MFFF.MODID, "textures/gui/gui_container.png");
    ...
    protected void renderLabels(MatrixStack matrixStack, int mouseX, int mouseY) {
        drawHorizontallyCenteredStringNoShadow(matrixStack, this.font, this.title, 1, 5, MFFF.MFFFTextColors.LIGHT_GRAY.code);
        this.font.draw(matrixStack, this.inventory.getDisplayName(), (float)this.inventoryLabelX, (float)this.inventoryLabelY, MFFF.MFFFTextColors.DARK_GRAY.code);
    }
